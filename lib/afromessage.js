...
export async function sendOtp(phone) {
  ...
  // Only attach from/sender if they're actually configured — sending the
  // literal string "undefined" is worse than omitting the param entirely.
  if (process.env.AFROMESSAGE_IDENTIFIER_ID) {
    params.set('from', process.env.AFROMESSAGE_IDENTIFIER_ID)
  }
  if (process.env.AFROMESSAGE_SENDER_NAME) {
    params.set('sender', process.env.AFROMESSAGE_SENDER_NAME)
  }
