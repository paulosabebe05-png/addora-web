  ...
  return (
    <header className={`${styles.header} ${transparent ? styles.transparent : styles.solid}`}>
      ...
      <div className={styles.inner}>
        ...
        {/* Mobile inline search — sits between logo and cart */}
        ...
        <div className={styles.actions}>
          ...
          {/* Auth — desktop only */}
          {user ? (
            <div className={`${styles.userMenu} ${styles.desktopOnly}`} onClick={e => e.stopPropagation()}>
            ...
            <div className={`${styles.authBtns} ${styles.desktopOnly}`}>
