            ...
            {todayDeals.length > 0 && (
              <section className={styles.section}>
                <SectionHeader
                  icon="🎯"
                  title="Today's Deals"
                  subtitle="Hand-picked savings"
                  seeAllHref="/?cat=deals"
                />
            ...
            {forYou.length > 0 && (
              <section className={styles.section}>
                <SectionHeader
                  icon="✨"
                  title="For You"
                  subtitle="Recommended picks"
                  seeAllHref="/?cat=foryou"
                />
